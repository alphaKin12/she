...
def second_page():
    ...
    With you, I have found a love that transcends time and space. Your kindness, your strength, and your unwavering support fill my heart with boundless joy. You have a heart of gold, and your love has transformed my life in the most beautiful ways.
    ...
    Your innocence and naivety are among the many things I adore about you. They paint you with a purity that is rare and beautiful in this world. Your heart, untouched by the cynicism of life, remains a beacon of light, guiding me with its gentle glow.
    ...
    I would cross the seas, scale the highest mountains, and traverse the widest deserts just to be with you. As Shakespeare beautifully penned, "The course of true love never did run smooth" (A Midsummer Night's Dream), but I am willing to face any obstacle, endure any hardship, to be by your side.

    Your naivety, your innocence, your silly decisions—they all make you the extraordinary person I have fallen deeply in love with. You are my muse, my insula, my Juno, and my heart's true desire.

    The world's definitely a harsh place. But will it be any sort of a paradise with you? Nope.
